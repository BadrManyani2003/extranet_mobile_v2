...
// begin-report-data
{"diagnostics":[{"problem":[{"text":"Configuring project ':lib' without an existing directory is deprecated. The configured projectDirectory 'C:\\PRJ\\extranet_mobile\\mobile\\node_modules\\react-native-reanimated\\android\\lib' does not exist, can't be written to or is not a directory. This behavior has been deprecated."}],"severity":"WARNING","problemDetails":[{"text":"This will fail with an error in Gradle 9.0."}],"contextualLabel":"Configuring project ':lib' without an existing directory is deprecated. The configured projectDirectory 'C:\\PRJ\\extranet_mobile\\mobile\\node_modules\\react-native-reanimated\\android\\lib' does not exist, can't be written to or is not a directory. This behavior has been deprecated.","documentationLink":"https://docs.gradle.org/8.13/userguide/upgrading_version_8.html#deprecated_missing_project_directory","problemId":[{"name":"deprecation","displayName":"Deprecation"},{"name":"configuring-project-lib-without-an-existing-directory-is-deprecated-the-configured-projectdirectory-c-prj-extranet-mobile-mobile-node-modules-react-native-reanimated-android-lib-does-not-exist-can-t-be-written-to-or-is-not-a-directory-this-behavior-has-been-deprecated","displayName":"Configuring project ':lib' without an existing directory is deprecated. The configured projectDirectory 'C:\\PRJ\\extranet_mobile\\mobile\\node_modules\\react-native-reanimated\\android\\lib' does not exist, can't be written to or is not a directory. This behavior has been deprecated."}],"solutions":[[{"text":"Make sure the project directory exists and can be written."}]]}],"problemsReport":{"totalProblemCount":1,"buildName":"android","requestedTasks":"","documentationLink":"https://docs.gradle.org/8.13/userguide/reporting_problems.html","documentationLinkCaption":"Problem report","summaries":[]}}
// end-report-data
);}
</script>
                <script type="text/javascript">
