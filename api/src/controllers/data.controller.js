...
const createHandler = (serviceMethod, resultType = 'array', ...queryParams) => asyncHandler(async (req, res) => {
    const { userId, source, token } = getContext(req);
    const args = queryParams.map(param => req.query[param]);
    const result = await dataService[serviceMethod](userId, source, token, ...args);
...
const getPolices = createHandler('getPolices');
const getSinistres = createHandler('getSinistres', 'array', 'policeId');
const getSinistresEnCours = createHandler('getSinistresEnCours', 'array', 'policeId');
const getRisques = createHandler('getRisques', 'array', 'policeId');
const getGaranties = createHandler('getGaranties', 'array', 'risqueId');
const getQuittances = createHandler('getQuittances', 'array', 'policeId');
const getImpayes = createHandler('getImpayes', 'array', 'policeId', 'enCour');
const getAdherents = createHandler('getAdherents', 'array', 'policeId');
const getPersACharge = createHandler('getPersACharge', 'array', 'adherentId');
...
const getStatsByPolice = createHandler('getStatsByPolice', 'object', 'policeId');
const getStatsKPIs = createHandler('getStatsKPIs', 'object', 'policeId', 'dateDu', 'dateAu');
const getStatsEvolutionAnnuelle = createHandler('getStatsEvolutionAnnuelle', 'array', 'policeId', 'dateDu', 'dateAu');
const getStatsTop5ITT = createHandler('getStatsTop5ITT', 'array', 'policeId', 'dateDu', 'dateAu');
const getStatsTop10Victimes = createHandler('getStatsTop10Victimes', 'array', 'policeId', 'dateDu', 'dateAu');
const getStatsRepartition = createHandler('getStatsRepartition', 'raw', 'policeId', 'dateDu', 'dateAu');
const getDocumentsByPolice = createHandler('getDocumentsByPolice', 'array', 'policeId');
